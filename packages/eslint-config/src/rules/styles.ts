...
export default {
    rules: {
        ...
        "arrow-parens": ["warn", "requireForBlockBody"], // Require parentheses around arrow function arguments
        ...
        "implicit-arrow-linebreak": ["warn", { "before": false, "after": true }], // Enforce the location of arrow function bodies
